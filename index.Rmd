...
A Curva ROC (Receiver Operating Characteristic Curve) no contexto do modelo de regressão logística permite avaliar o potencial da capacidade preditiva do modelo estimado a partir da relação entre as medidas de sensibilidade (*verdadeiros positivos*) e de especificidade (*verdadeiros positivos*).


```{r, out.width='70%', fig.align='center',echo=FALSE}
knitr::include_graphics('libs/fig/fig_matrizconfusao.png')
...
```{r, out.width='70%', fig.align='center',echo=FALSE}
knitr::include_graphics('libs/fig/ROC.jpg')
...
```{r, out.width='70%', fig.align='center', echo=FALSE}
knitr::include_graphics('libs/fig/fig0.png')
```
...
knitr::include_graphics('libs/fig/fig1.png')
```
...
```{r, out.width='70%', fig.align='center', echo=FALSE}
knitr::include_graphics('libs/fig/fig2.png')
...
knitr::include_graphics('libs/fig/fig3.png')
```
...
```{r, out.width='70%', fig.align='center', echo=FALSE}
knitr::include_graphics('libs/fig/fig4.png')
```
...
```{r, out.width='70%', fig.align='center', echo=FALSE}
knitr::include_graphics('libs/fig/fig5.png')
```
